...
<!-- Mirrored from demo.webtend.net/html/qoll/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Nov 2023 15:31:20 GMT -->
<head>
    <!--====== Required meta tags ======-->
    <meta charset="utf-8" />
    ...
    <!--====== Title ======-->
    <title>Qoll - Agency HTML Template || Blog Details</title>
    <!--====== Favicon Icon ======-->
...
<body class="home-one">
    <div class="page-wrapper">
        ...
        <section class="page-banner-area rel z-1 pt-220 pb-145 rpb-125 bg-dark-blue text-white">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h2 class="page-title wow fadeInRight delay-0-2s">Blog Details</h2>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-lg-8">
                        <div class="single-blog-post blog-details-content pr-xl-5">
                            <div class="post-thumbnail wow fadeInUp delay-0-2s">
                                <img src="assets/images/blog/blog-single.jpg" alt="Blog Single">
                            </div>
                            <div class="post-content">
                                ...
                                <ul class="post-meta">
                                    ...
                                    <li>
                                        <a href="#"><i class="far fa-calendar-alt"></i> 25 Sep 2021</a>
                                    </li>
                                </ul>
                                <h3 class="post-title">Front-End Performance Checklist 2021 PDF,  Apple Pages, MS Word</h3>
                                <p>
                                    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium dolor emque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam vluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni lores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui doloem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur
                                </p>
                                <blockquote>
                                    <p>Smashing Podcast Episode Pauloag Conve Optimization Inspired Decisions</p>
                                ...
                                <div class="comment-template mt-45">
                                    <h4 class="template-title mb-45">Peopel Comments</h4>

                                    <ul class="comment-list wow fadeInUp delay-0-2s">
                                        <li>
                                            <div class="comment-body">
                                                <div class="author-thumb">
                                                    <img src="assets/images/blog/comment-author-01.jpg" alt="Image">
                                                </div>
                                            ...
                                            <ul class="children">
                                                <li>
                                                    <div class="comment-body">
                                                        <div class="author-thumb">
                                                            <img src="assets/images/blog/comment-author-02.jpg" alt="Image">
                                                        </div>
                                                        <div class="comment-content">
                                                            <h6 class="name">
                                                                Jeffrey T. Kelly
                                        ...
                                        <li>
                                            <div class="comment-body">
                                                <div class="author-thumb">
                                                    <img src="assets/images/blog/comment-author-03.jpg" alt="Image">
                                                </div>
                                                <div class="comment-content">
                                                    <h6 class="name">
                                                        Richard B. Zellmer
                                    ...
                                    <div class="comment-form wow fadeInUp delay-0-2s">
                                        <h4 class="template-title my-45">Leave A Message</h4>
                                        ...
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-field mb-30">
                                                        <textarea rows="4" placeholder="Write Comment" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="input-field">
                                                        <button type="submit" class="theme-btn">Leave a Comments <i class="fas fa-long-arrow-alt-right"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="primary-sidebar rmt-75">
                            <div class="widget search-widget wow fadeInUp delay-0-2s">
                                <h4 class="search-title">Search Here</h4>
                                <form>
                            ...
                            <div class="widget latest-post-widget wow fadeInUp delay-0-2s">
                                ...
                                <div class="popular-posts-wrapper">
                                    <div class="popular-posts-item">
                                        <div class="popular-posts-thumbnail">
                                            <a href="blog-details.html">
                                                <img src="assets/images/blog/latest-post-thumbnail-1.jpg"
                                                    alt="latest post one">
                                            </a>
                                        </div>
                                        <div class="popular-posts-item-content">
                                            <h6 class="popular-posts-title"><a href="blog-details.html">Build Seamless Spreadshet Import Experience</a></h6>
                                    ...
                                    <div class="popular-posts-item">
                                        <div class="popular-posts-thumbnail">
                                            <a href="blog-details.html">
                                                <img src="assets/images/blog/latest-post-thumbnail-2.jpg"
                                                    alt="latest post two">
                                            </a>
                                        </div>
                                        <div class="popular-posts-item-content">
                                            <h6 class="popular-posts-title"><a href="blog-details.html">Creating Online Environment Work Well Older</a></h6>
                                            <a href="#" class="posts-date"><i class="far fa-calendar-alt"></i> 25 May 2022</a>
                                        </div>
                                    </div>
                                    <div class="popular-posts-item">
                                        <div class="popular-posts-thumbnail">
                                            <a href="blog-details.html">
                                                <img src="assets/images/blog/latest-post-thumbnail-3.jpg"
                                                    alt="latest post three">
                                            </a>
                                        </div>
                                        <div class="popular-posts-item-content">
                                            <h6 class="popular-posts-title"><a href="blog-details.html">Signs Website Feels More Haunted House</a></h6>
                                            <a href="#" class="posts-date"><i class="far fa-calendar-alt"></i> 25 May 2022</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="widget cta-widget text-white wow fadeInUp delay-0-2s" style="background-image: url(assets/images/blog/cta-widget.jpg);">
                                ...
                                <a href="#" class="theme-btn">Let’s Talk SEO <i class="fas fa-long-arrow-alt-right"></i></a>
                            </div>
        ...
        <!-- Footer Area Start -->
        <footer class="main-footer z-1 rel bg-dark-blue text-white pt-100">
            <div class="container">
               <div class="location-social pt-40 pb-10">
                ...
                <div class="copyright-area pt-25 pb-15">
                    ...
                    <p>Copyright @2022 Qolle All Rights Reserved</p>
                </div>
            </div>
...
<!-- Mirrored from demo.webtend.net/html/qoll/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Nov 2023 15:31:32 GMT -->
</html>